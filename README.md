...
- 围绕灵析四大关注点组织信息：网络筹款、会员管理、Service Center、年度收支。
...
安装后重启 Codex，或重新打开会话，让 skill metadata 生效。
...
- 不适合写成通用百科介绍；如果信息和灵析四大关注点无关，应压缩或删去。
- 输出给 Raymond 使用，默认不在末尾加自评、评分或“做得好/不足”总结。
